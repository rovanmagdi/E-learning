    ...
    >
      <Grid container spacing={2} sx={{ width: "800px", margin: "auto" }}>
        <Grid xs={4} sx={{ fontSize: "0.8rem", padding: "6px" }}>
          ...
          <Typography variant="span" sx={{ color: "#198754" }}>
            Liberian people’s.
          </Typography>
        </Grid>
        <Grid xs={1}>
          <Box
            component="img"
            src="https://htmldemo.net/edule/eduLe/assets/images/shape/shape-1.png"
            height="10px"
          ></Box>
        </Grid>
        <Grid xs={2}>
        ...
        <Grid xs={1}>
          <Box
            component="img"
            src="https://htmldemo.net/edule/eduLe/assets/images/shape/shape-2.png"
            height="10px"
          ></Box>
        </Grid>
